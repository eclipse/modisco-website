<?php  																														require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/app.class.php");	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/nav.class.php"); 	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/menu.class.php"); 	$App 	= new App();	$Nav	= new Nav();	$Menu 	= new Menu();		include($App->getProjectCommon());    # All on the same line to unclutter the user's desktop'
	...
	<div id="midcolumn">
		...
		<p align="justify">
	  	...
	  	<p align="justify">
			Next, the generated UML models are transformed to OWL ontologies using the <b>UML2ToPackageAPIOntology.atl</b> model transformation and the IODT ontology framework. This transformation is superimposed on top of the <b>UML2ToAPIOntology.atl</b> model transformation, which contains all the OCL logic for calculating package dependencies. It also contains OCL logic to calculate compatibility relationships between the various Java APIs. Compatibility is only calculated up to a certain extent: compatibility and equivalence is calculated at package level, not at class/interface level. This results in sometimes unexpected incompatibilities between Java packages that one would expect to be backward compatible. The causes of these incompatibilities can be found in the ATL transformation build log of the model transformations that built the Java API ontologies.
			<br>
			Note that everytime you want to generate an improved version of the ontologies, the ATL transformation needs to be run again on all UML models. In this particular case, the runtime of the single ATL transformation run can go up to 90 minutes.
	  	</p>
		<p align="justify">
